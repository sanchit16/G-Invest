      ...
      <main className="flex-1 p-4 md:p-6 lg:p-8 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
                ...
                <StockCategoryList title="Popular ETFs" stocks={popularETFs} className="mt-8" />
                <StockCategoryList title="Most Followed on G-Invest" stocks={mostFollowed} className="mt-8" />
            </div>
            <div>
                <StockDetail />
            </div>
