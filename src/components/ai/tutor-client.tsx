...
import { BookOpen, CheckCircle, Bot, Sparkles, AlertTriangle, Info, Lock, HelpCircle, KeyRound } from 'lucide-react';
    ...
    async function onSubmit(values: ChatFormValues) {
        if (!apiKey) {
            toast({
                ...
                description: "Please enter your Generative AI API key to use the AI Tutor.",
                variant: "destructive",
            });
            return;
        }
            ...
            <CardContent>
                <div className="space-y-4">
                    ...
                    <Alert variant="default" className="mt-4">
                        ...
                        <AlertDescription>
                            The AI Tutor is a guide for learning. For personal financial decisions, please consult with a human expert.
                        </AlertDescription>
                    </Alert>
                </div>
            </CardContent>
